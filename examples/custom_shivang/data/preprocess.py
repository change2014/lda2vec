...
texts = pd.read_csv("inputData.csv") # Input Data

texts = list(texts.Response) # column where text is present 

# remove stopwords #shivang
...
n_dim = 300
fn_wordvc = 'word2vec_March1' # pretrained word vectors location
